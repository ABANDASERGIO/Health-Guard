...
export default function HospitalAdminSettingsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Settings"
        description="Hospital administrator account security, notifications, and workspace information."
      />
          ...
          <CardContent className="p-6">
            ...
            <div className="mt-4 space-y-3">
              ...
              <div className="rounded-2xl bg-muted-bg/40 p-4 text-sm text-muted">
                ...
                <div className="mt-2">Controls whether the admin notifications UI fetches/shows items.</div>
              </div>
            </div>
          </CardContent>
        </Card>

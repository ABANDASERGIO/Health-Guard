  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-6 py-16">
      <div className="max-w-md text-center">
        ...
        <p className="text-sm font-semibold uppercase tracking-wider text-muted">HealthGuard</p>
        <h1 className="mt-3 text-4xl font-semibold tracking-tight text-foreground">404</h1>
        <p className="mt-4 text-muted">
          This route is not part of your active workspace. If you followed a bookmarked secure link, verify you are signed
